...
static const _Message_type_support_symbol_names_t _Message_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tut_interfaces, msg, Message)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tut_interfaces, msg, Message)),
  }
};
...
{
  return &::tut_interfaces::msg::rosidl_typesupport_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tut_interfaces, msg, Message)() {
  return get_message_type_support_handle<tut_interfaces::msg::Message>();
}
