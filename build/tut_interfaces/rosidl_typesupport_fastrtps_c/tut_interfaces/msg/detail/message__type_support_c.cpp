...
#include "tut_interfaces/msg/detail/message__rosidl_typesupport_fastrtps_c.h"
...
using _Message__ros_msg_type = tut_interfaces__msg__Message;
...
size_t get_serialized_size_tut_interfaces__msg__Message(
  const void * untyped_ros_message,
...
static uint32_t _Message__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tut_interfaces__msg__Message(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tut_interfaces
size_t max_serialized_size_tut_interfaces__msg__Message(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Message__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tut_interfaces__msg__Message(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tut_interfaces, msg, Message)() {
