...
#include "tut_interfaces/msg/detail/message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tut_interfaces::msg::Message *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tut_interfaces::msg::Message *>(
    untyped_ros_message);
...
{
  return &tut_interfaces::msg::typesupport_fastrtps_cpp::_Message__handle;
}
