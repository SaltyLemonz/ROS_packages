...
{
  new (message_memory) tut_interfaces::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tut_interfaces::msg::Message *>(message_memory);
  typed_message->~Message();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[1] = {
  {
    "flag",  // name
    ...
    offsetof(tut_interfaces::msg::Message, flag),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Message_message_members = {
  ...
  1,  // number of fields
  sizeof(tut_interfaces::msg::Message),
...
get_message_type_support_handle<tut_interfaces::msg::Message>()
{
  return &::tut_interfaces::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tut_interfaces, msg, Message)() {
  return &::tut_interfaces::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
