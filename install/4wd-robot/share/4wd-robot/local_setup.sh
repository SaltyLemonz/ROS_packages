...
: ${AMENT_CURRENT_PREFIX:="/home/sid/ros2_ws/install/4wd-robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/4wd-robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/4wd-robot/environment/path.sh"
